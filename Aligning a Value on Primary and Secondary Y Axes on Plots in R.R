...
# value doesn't necessarily have to be 0, and you can even
# align one value on the primary y axis with another value
# on the secondary y axis. We'll define two values to
# align - one ('Primary_Y_Axis_Value_to_Align') will be for
# the primary y axis and the other
# ('Secondary_Y_Axis_Value_to_Align') will be for the
# secondary y axis. More often than not, these two values
# will be the same, and usually, they will both be 0.
...
# Let's first define the values to align the axes by.

Primary_Y_Axis_Value_to_Align <- 0
Secondary_Y_Axis_Value_to_Align <- 0
...
mtext("Primary Y Axis Variable", 2, 2.5)
title("Aligning Primary and Secondary Y Axes")
abline(h = Primary_Y_Axis_Value_to_Align, lty = 2)
par(new = T)
...
mtext("Secondary Y Axis Variable", 4, 2.5)
abline(h = Secondary_Y_Axis_Value_to_Align, col = 2, lty = 2)
legend("bottom", legend = c("Primary X Axis Variable", "Secondary X Axis Variable"), pch = 1, col = 1:2, xpd = T, inset = c(0, -0.45))
...
# This function takes 6 arguments, and the first two are
# required:
...
# 'Primary_Y_Axis_Value_to_Align' is the value you wish
# to align on the primary y axis.

# 'Secondary_Y_Axis_Value_to_Align' is the value you wish
# to align on the secondary y axis.
...
Axis_Limits_for_Primary_and_Secondary_Y_Axes_Aligned_by_a_Value_Function <- function (Primary_Y_Axis_Variable, Secondary_Y_Axis_Variable, Data_Frame, Primary_Y_Axis_Value_to_Align = 0, Secondary_Y_Axis_Value_to_Align = 0, Axis_Buffer = 10) {
  ...
  if (!any(sapply(list(Primary_Y_Axis_Variable, Secondary_Y_Axis_Variable, Primary_Y_Axis_Value_to_Align, Secondary_Y_Axis_Value_to_Align, Axis_Buffer), is.numeric))) {
...
# This function works on our made-up data:

Axis_Limits_for_Primary_and_Secondary_Y_Axes_Aligned_by_a_Value_Function(Primary_Y_Axis_Variable, Secondary_Y_Axis_Variable, Practice_Data)
