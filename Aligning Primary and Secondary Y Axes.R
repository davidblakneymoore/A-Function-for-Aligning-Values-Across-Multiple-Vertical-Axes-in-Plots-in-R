...
# Aligning a Value on Primary and Secondary Y Axes in R
# David Moore
...
if (Axis_to_Align == "Primary") {
  Primary_Y_Axis_Range <- if(Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range > Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range) {
    # This part takes care of the case when the primary axis's scale must shift up to align properly
    ...
    # This part takes care of the case when the primary axis's scale must shift down to align properly
  ...
  Secondary_Y_Axis_Range <- if(Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range > Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range) {
    # This part takes care of the case when the secondary axis's scale must shift up to align properly
    ...
    # This part takes care of the case when the secondary axis's scale must shift down to align properly
