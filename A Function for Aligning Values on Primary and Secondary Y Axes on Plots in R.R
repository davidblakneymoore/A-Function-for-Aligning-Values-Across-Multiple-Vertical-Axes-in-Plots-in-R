...
Axis_Limits_for_Primary_and_Secondary_Y_Axes_Aligned_by_a_Value_Function <- function (Primary_Y_Axis_Variable, Secondary_Y_Axis_Variable, Data_Frame, Primary_Y_Axis_Value_to_Align = 0, Secondary_Y_Axis_Value_to_Align = 0, Ratio_of_Value_to_Align_to_Y_Axis_Range = NULL, Axis_Scale_to_Preserve = "Neither", Axis_Buffer = 10) {
  ...
  if (Axis_Scale_to_Preserve == "Primary" & ((Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range < 0 & (Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range < 1 & Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range > 0)) | (Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range > 1 & (Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range < 1 & Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range > 0)) | (Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range < 0 & Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range > 1) | (Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range > 1 & Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range < 0))) {
  ...
  if (Axis_Scale_to_Preserve == "Secondary" & ((Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range < 0 & (Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range < 1 & Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range > 0)) | (Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range > 1 & (Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range < 1 & Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range > 0)) | (Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range < 0 & Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range > 1) | (Ratio_of_Value_to_Align_to_Secondary_Y_Axis_Range > 1 & Ratio_of_Value_to_Align_to_Primary_Y_Axis_Range < 0))) {
